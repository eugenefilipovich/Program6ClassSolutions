...
namespace Favorit.es.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var flickr = new Flickr("40852f65c997ac5fd1128a360fcae04d", "15ab386cd8a20bf5"); 
        ...
        {
            // http://localhost:29548/home/unfavorite/16103343374
            //get the object from the UserFavorites based on the ID
            AddFavoriteViewModel toRemove = this.UserFavorites.First(x => x.id == id);
            //remove that object from the UserFavorites
            this.UserFavorites.Remove(toRemove);
